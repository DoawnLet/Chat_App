        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MutedUntil = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientMessageId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Type = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Platform = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    UpdatedAtToken = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationTokens_Devices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageAttachments_MediaObjects_MediaId",
                        column: x => x.MediaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_OwnerId_TargetId",
                table: "Contacts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaObjects_Status",
                table: "MediaObjects",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_MediaObjects_StorageKey",
                table: "MediaObjects",
                column: "StorageKey",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageReceipts_UserId_Status_Timestamp",
                table: "MessageReceipts",
                columns: new[] { "UserId", "Status", "Timestamp" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationTokens_DeviceId_Token",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_UserId_DeviceId_ExpiresAt",
                table: "RefreshTokens",
                columns: new[] { "UserId", "DeviceId", "ExpiresAt" });
